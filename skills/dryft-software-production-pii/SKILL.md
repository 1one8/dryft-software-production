---
name: dryft-software-production-pii
...
Find the owning Dryft workspace via `.dryft/config.json`. Read the installed
`.dryft/stacks/dryft-software-production/docs/workflow.md`. Resolve the requested
project ID through core `dryft --workspace WORKSPACE project list` and
...
Read `.dryft/stacks/dryft-software-production/docs/privacy-review.md` and follow
